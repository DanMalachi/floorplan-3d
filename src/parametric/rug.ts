...
export const rugGenerator: GeneratorDef = {
  ...
  variants: [
    {
      id: "area",
      labelKey: "rug.variants.area.label",
      cardLabelKey: "rug.variants.area.cardLabel",
      hotspotKeywords: ["rug", "carpet"],
      defaults: { dims: { w: 1.7, d: 2.4, h: 0.02 }, finish: "rug-wool" },
    },
    {
      id: "round",
      labelKey: "rug.variants.round.label",
      cardLabelKey: "rug.variants.round.cardLabel",
      hotspotKeywords: ["rug", "carpet"],
      defaults: { dims: { w: 1.6, d: 1.6, h: 0.038 }, finish: "rug-shag" },
    },
    {
      id: "persian",
      labelKey: "rug.variants.persian.label",
      cardLabelKey: "rug.variants.persian.cardLabel",
      hotspotKeywords: ["rug", "carpet", "persian"],
      defaults: { dims: { w: 2.0, d: 3.0, h: 0.014 }, finish: "rug-persian" },
    },
    {
      id: "modern",
      labelKey: "rug.variants.modern.label",
      cardLabelKey: "rug.variants.modern.cardLabel",
      hotspotKeywords: ["rug", "carpet"],
      defaults: { dims: { w: 2.0, d: 2.9, h: 0.016 }, finish: "rug-modern" },
    },
    {
      id: "jute",
      labelKey: "rug.variants.jute.label",
      cardLabelKey: "rug.variants.jute.cardLabel",
      hotspotKeywords: ["rug", "carpet", "mat"],
