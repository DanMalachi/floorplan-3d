...
export const applianceGenerator: GeneratorDef = {
  ...
  modules: [
    {
      key: "doorOpen",
      labelKey: "appliance.modules.doorOpen.label",
      min: 0,
      max: 1,
      default: 0,
      toggle: { onKey: "appliance.modules.doorOpen.toggle.on", offKey: "appliance.modules.doorOpen.toggle.off" },
      appliesTo: (spec) => CAN_OPEN.has(variantOf(spec)),
    },
    {
      key: "burners",
      labelKey: "appliance.modules.burners.label",
      min: 4,
      max: 6,
      default: 5,
  ...
  variants: [
    {
      id: "fridge-2door",
      labelKey: "appliance.variants.fridge-2door.label",
      cardLabelKey: "appliance.variants.fridge-2door.cardLabel",
    ...
    },
    {
      ...
      labelKey: "appliance.variants.fridge-side-by-side.label",
      cardLabelKey: "appliance.variants.fridge-side-by-side.cardLabel",
      hotspotKeywords: ["fridge", "refrigerator"],
      rooms: ["kitchen"],
    ...
    },
    {
      ...
      labelKey: "appliance.variants.fridge-under-counter.label",
      cardLabelKey: "appliance.variants.fridge-under-counter.cardLabel",
      hotspotKeywords: ["fridge", "refrigerator"],
      rooms: ["kitchen"],
    ...
    {
      id: "oven",
      labelKey: "appliance.variants.oven.label",
      cardLabelKey: "appliance.variants.oven.cardLabel",
    ...
    {
      id: "range-cooker",
      labelKey: "appliance.variants.range-cooker.label",
      cardLabelKey: "appliance.variants.range-cooker.cardLabel",
    ...
    },
    {
      ...
      labelKey: "appliance.variants.dishwasher-integrated.label",
      cardLabelKey: "appliance.variants.dishwasher-integrated.cardLabel",
    ...
    {
      id: "dishwasher-steel",
      labelKey: "appliance.variants.dishwasher-steel.label",
      cardLabelKey: "appliance.variants.dishwasher-steel.cardLabel",
      hotspotKeywords: ["dishwasher"],
      rooms: ["kitchen"],
    ...
    {
      id: "washer",
      labelKey: "appliance.variants.washer.label",
      cardLabelKey: "appliance.variants.washer.cardLabel",
    ...
    {
      id: "dryer",
      labelKey: "appliance.variants.dryer.label",
      cardLabelKey: "appliance.variants.dryer.cardLabel",
    ...
    },
    {
      ...
      labelKey: "appliance.variants.washer-dryer-stack.label",
      cardLabelKey: "appliance.variants.washer-dryer-stack.cardLabel",
    ...
    {
      id: "microwave",
      labelKey: "appliance.variants.microwave.label",
      cardLabelKey: "appliance.variants.microwave.cardLabel",
    ...
    },
    {
      ...
      labelKey: "appliance.variants.microwave-over-range.label",
      cardLabelKey: "appliance.variants.microwave-over-range.cardLabel",
      hotspotKeywords: ["microwave"],
      rooms: ["kitchen"],
