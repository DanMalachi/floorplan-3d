  ...
  return (
    <>
      ...
      <ul style={legalUl}>
        ...
        <li style={legalLi}>
          <b>ניגודיות.</b> חלק מהתוויות האפורות הקטנות בעמודי &quot;אודות&quot;,
          &quot;שאלות נפוצות&quot; ו&quot;מחירים&quot;, והכיתוב מתחת להדגמה בעמוד
          הבית, נמצאים מתחת ליחס ניגודיות של 4.5:1.
        </li>
        <li style={legalLi}>
          אי אפשר לעצור את הכותרת המתחלפת בעמוד הבית.
        </li>
        <li style={legalLi}>
