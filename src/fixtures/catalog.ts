...
// construction — every fixture id is "fx:"-prefixed, a namespace-prefix
// convention the furniture catalog also uses.
//
...
// branded/CC0 fixture catalog (mirroring the furniture catalog's import
...
export interface FixtureAsset {
   ...
   *
   *  These three ARE translatable, unlike a branded model name, because they are
