...
export const demoScene: Scene = {
  ...
  furniture: [
    ...
    { id: "f6", assetId: "blenderkit:30a3d1c5-6554-42fd-a8d0-a1efdff162b3", x: 5.64, y: 1.55, rotation: -Math.PI / 2 }, // Painted Wooden Cabinet
    ...
    fixture("f11", "toilet", -1.42, 3.62, Math.PI / 2),
    fixture("f12", "vanity", -1.05, 4.72, Math.PI),
  ],
};
